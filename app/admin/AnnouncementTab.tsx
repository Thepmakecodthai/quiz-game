...
export default function AnnouncementTab() {
  ...
  `)
    ...
    const formatted: WinnerRow[] = (data || []).map((item: any) => ({
      ...item,
  ...
  return (<div className="p-4 bg-white rounded-xl"> <p className="mb-3 text-sm text-gray-500">
    ผลการประกาศ </p>
          ...
          {winners.map((winner) => (
            ...
            >
              <p className="font-medium">
                #{winner.rank} {winner.players.name}
              </p>

              <p className="text-sm text-gray-500">
                รหัสนิสิต: {winner.players.student_id}
              </p>
