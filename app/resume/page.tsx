  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-purple-50 px-4">
      <div className="w-full max-w-sm bg-white p-8 rounded-[2rem] shadow-sm border border-purple-100">
        ...
        <h1 className="text-xl font-bold text-purple-700 text-center mb-6">
          เข้าสู่ระบบ
        </h1>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div>
            <label className="text-sm text-purple-700 ml-2 block mb-2">
              รหัสนิสิต
            </label>
            ...
            <input
              ...
              className="w-full px-5 py-3 rounded-2xl bg-purple-50 border border-purple-100
          ...
          <button
            type="submit"
            className="w-full py-3 rounded-2xl bg-purple-600 text-white font-semibold
